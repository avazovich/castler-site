...
export const projects: Project[] = [
  ...
  {
    slug: "akhsikent-dacha",
    title: "Akhsikent Dacha",
    location: "Akhsikent, Uzbekistan",
    year: "2026",
    category: "architecture",
    image: "/projects/akhsikent-dacha-hero.jpg",
    summary: "A charcoal-and-travertine dacha built around a lap pool, its dark slate cladding and cypress courtyard giving way to a glazed riverside elevation of timber and stone.",
    description: [
      "The dacha's street face is deliberately restrained — dark stone, a slatted timber door, cypress trees planted in strict rows — before opening onto a pool terrace framed by full-height glazing and a bronze water sculpture.",
      "A rear elevation facing the water trades the entrance's formality for openness: two storeys of glass and travertine wrapped in deep roof overhangs, designed to be read from the riverbank as much as from the garden.",
    ],
    galleryCount: 10,
    gallery: Array.from({ length: 9 }, (_, i) => `/projects/akhsikent-dacha-${String(i + 1).padStart(2, "0")}.jpg`),
  },
  {
    slug: "chortoq-estate",
  ...
  {
    slug: "lakeside-resort-pavilion",
    title: "Lakeside Resort Pavilion",
    location: "Uzbekistan",
    year: "2026",
    category: "architecture",
    image: "/projects/lakeside-resort-pavilion-hero.jpg",
    summary: "A resort pavilion built around a gilded, star-lit porte-cochère, its curved colonnade opening onto a lakeside restaurant terrace of sculpted pine and hanging chandeliers.",
    description: [
      "The entrance sequence is built for arrival: a sweeping bronze-and-gold canopy, backlit in a grid of small points of light, draws cars under cover before opening onto a fountain court framed by dark marble columns.",
      "The terrace beyond trades gold for a quieter palette — sculpted pine, crystal pendant lighting, and glass-walled dining pods set against the water — carrying the same sense of occasion from the porte-cochère through to the table.",
    ],
    galleryCount: 5,
    gallery: Array.from({ length: 4 }, (_, i) => `/projects/lakeside-resort-pavilion-${String(i + 1).padStart(2, "0")}.jpg`),
  },
];
